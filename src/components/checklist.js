    ...
    <div class="card">
        ...
        <div class="card-body">
              ...
              <table class="table table-bordered m-0">
                ...
                <tbody> 
                  <tr>
                    <td class="p-4">
                      <div class="media align-items-center">
                        <img src="https://i.pinimg.com/736x/88/88/44/888844c0a9d50e697931fd2640a4a345.jpg" class="d-block ui-w-40 ui-bordered mr-4" alt=""/>
                  ...
                  <tr>
                    <td class="p-4">
                      <div class="media align-items-center">
                        <img src="https://5.imimg.com/data5/ANDROID/Default/2020/12/HD/GC/WI/38011833/product-jpeg-500x500.jpg" class="d-block ui-w-40 ui-bordered mr-4" alt=""/>
                        <div class="media-body">
                  ...
                  <tr>
                    <td class="p-4">
                      <div class="media align-items-center">
                        <img src="https://www.justprotools.com.au/assets/thumbL/230.jpg?20210309031441" class="d-block ui-w-40 ui-bordered mr-4" alt=""/>
                        <div class="media-body">
            ...
            <div class="float-right">
              <Link to="/home"> 
              <button type="button" class="btn btn-lg btn-success mt-2">continue shopping</button>
              </Link>

              <Link to="/Addressform">
              <button type="button" class="btn btn-lg btn-success mt-2">Next</button>
              </Link>
